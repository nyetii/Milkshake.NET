...
namespace Kimi.Logging
{
    public class Log
    {
        ...
        public static async Task Write(Milkshake.LogMessage message)
        {
            var severity = message.Severity switch
            {
                Milkshake.Severity.Fatal => LogEventLevel.Fatal,
                Milkshake.Severity.Error => LogEventLevel.Error,
                Milkshake.Severity.Warning => LogEventLevel.Warning,
                Milkshake.Severity.Information => LogEventLevel.Information,
                Milkshake.Severity.Verbose => LogEventLevel.Verbose,
                Milkshake.Severity.Debug => LogEventLevel.Debug,
                _ => LogEventLevel.Information
            };
